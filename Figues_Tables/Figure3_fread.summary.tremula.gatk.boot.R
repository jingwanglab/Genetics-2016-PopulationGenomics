...
f=function(count,number){  ###count is the table and n is the number of sites for either 4-fold or 0-fold sites
        ...
        maf=as.integer(count_sample$V4*48)
...
###1.0-fold
Outfile=paste("/proj/b2010014/GenomePaper/population_genetics/pan_genome/shared/three_species/zero_fold/dfe/tremula/bootstrap/bootstrap",bootstrap_n,"/tremula.zero_fold.bootstrap",bootstrap_n,".txt",sep="")
cat("1",file=Outfile)
...
Outfile_omega=paste("/proj/b2010014/GenomePaper/population_genetics/pan_genome/shared/three_species/zero_fold/dfe/tremula/bootstrap/bootstrap",bootstrap_n,"/tremula.zero_fold.bootstrap",bootstrap_n,".omega.txt",sep="")

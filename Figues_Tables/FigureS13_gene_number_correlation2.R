...
png(filename="3species.1Mb.gene_density.correlation2.png",width = 6, height = 6, units = 'in', res=500)

par(mfcol=c(3,3))
par(omi=c(0.3,0.1,0.1,0))
par(mar=c(2,3.5,1,0.2))
...
plot(tremula_cor_parameters_new$Gene_num,tremula_cor_parameters_new$tremula_ldhat_new,pch=19,col="grey",cex=.5,cex.lab=1.5,cex.axis=0.7,xlab="",ylab=expression(rho))
#abline(v=85,lty=2)
...
mtext(expression(italic(P.tremula)),side=3,line=0.05,adj=.45,font=1.3,cex=1)
#mtext(expression(rho),side=3,line=-5.5,adj=-0.25,font=0.8,cex=0.8)
...
plot(tremula_cor_parameters_new$Gene_num,tremula_cor_parameters_new$Thetas_tremula_four_fold_tP,pch=19,col="grey",cex=.5,cex.lab=1.5,cex.axis=0.7,xlab="",ylab=expression(theta[4-fold]))
#abline(v=85,lty=2)
...
#mtext(expression(theta[4-fold]),side=3,line=-5.5,adj=-0.4,font=0.8,cex=0.8)

plot(tremula_cor_parameters_new$Gene_num,tremula_cor_parameters_new$Thetas_tremula_intergenic_tP,pch=19,col="grey",cex=.5,cex.lab=1.5,cex.axis=0.7,ylab=expression(theta[Intergenic]),xlab="")
#abline(v=85,lty=2)
...
#mtext(expression(theta[Intergenic]),side=3,line=-5.8,adj=-0.5,font=0.8,cex=0.8)


###tremuloides

plot(tremuloides_cor_parameters_new$Gene_num,tremuloides_cor_parameters_new$tremuloides_ldhat_new,pch=19,col="grey",cex=.5,cex.lab=1,cex.axis=0.7,ylab="",xlab="")
#abline(v=85,lty=2)
...
#mtext("(b)",side=3,line=0.05,adj=-0.35,font=1.5,cex=1.2)
mtext(expression(italic(P.tremuloides)),side=3,line=0.05,adj=.45,font=1.3,cex=1)

plot(tremuloides_cor_parameters_new$Gene_num,tremuloides_cor_parameters_new$Thetas_tremuloides_four_fold_tP,pch=19,col="grey",cex=.5,cex.lab=1,cex.axis=0.7,ylab="",xlab="")
#abline(v=85,lty=2)
...
plot(tremuloides_cor_parameters_new$Gene_num,tremuloides_cor_parameters_new$Thetas_tremuloides_intergenic_tP,pch=19,col="grey",cex=.5,cex.lab=1,cex.axis=0.7,ylab="",xlab="")
#abline(v=85,lty=2)
...
###trichocarpa
plot(trichocarpa_cor_parameters_new$Gene_num,trichocarpa_cor_parameters_new$trichocarpa_ldhat_new,pch=19,col="grey",cex=.5,cex.lab=1,cex.axis=0.7,ylab="",xlab="")
#abline(v=85,lty=2)
...
#mtext("(c)",side=3,line=0.05,adj=-0.35,font=1.5,cex=1.2)
mtext(expression(italic(P.trichocarpa)),side=3,line=-0.1,adj=.45,font=1.3,cex=1)

plot(trichocarpa_cor_parameters_new$Gene_num,trichocarpa_cor_parameters_new$Thetas_trichocarpa_four_fold_tP,pch=19,col="grey",cex=.5,cex.lab=1,cex.axis=0.7,ylab="",xlab="")
#abline(v=85,lty=2)
...
plot(trichocarpa_cor_parameters_new$Gene_num,trichocarpa_cor_parameters_new$Thetas_trichocarpa_intergenic_tP,pch=19,col="grey",cex=.5,cex.lab=1,cex.axis=0.7,ylab="",xlab="")
#abline(v=85,lty=2)
...
mtext("Gene number/Mbp",side=1,line=0.5,adj=0.5,font=1.5,cex=1.2,outer=T)
dev.off()
...
tremula.lm=lm(tremula_ldhat_new~Gene_num,data=tremula_cor_parameters_new)
tremula.seg=segmented(tremula.lm,seg.Z=~Gene_num,psi=list(Gene_num=c(85)))
summary(tremula.seg)
tremula.seg$psi
slope(tremula.seg)
tremula.fitted <- fitted(tremula.seg)
tremula.model=data.frame(gene_number=tremula_cor_parameters_new$Gene_num,recombination=tremula.fitted)
ggplot(tremula.model,aes=c(x=gene_number,y=recombination))+geom_line()


trichocarpa.lm=lm(trichocarpa_ldhat_new~Gene_num,data=trichocarpa_cor_parameters_new)
trichocarpa.seg=segmented(trichocarpa.lm,seg.Z=~Gene_num,psi=list(Gene_num=c(85)))
summary(trichocarpa.seg)

...
#tremula
tremula_gene=read.table("/proj/b2010014/GenomePaper/population_genetics/GATK/HC/snp_filter/tremula/plink_gene_intergene_regulatory/gene/thin_ld/3species.snp.rm_indel.biallelic.DP5.GQ10.bed.tremula.gene.plink.thin.r2.ld",header=T)
tremula_intergene=read.table("/proj/b2010014/GenomePaper/population_genetics/GATK/HC/snp_filter/tremula/plink_gene_intergene_regulatory/intergene/thin_ld/3species.snp.rm_indel.biallelic.DP5.GQ10.bed.tremula.intergene.plink.thin.r2.ld",header=T)
#tremuloides
tremuloides_gene=read.table("/proj/b2010014/GenomePaper/population_genetics/GATK/HC/snp_filter/tremuloides/plink_gene_intergene_regulatory/gene/thin_ld/3species.snp.rm_indel.biallelic.DP5.GQ10.bed.tremuloides.gene.plink.thin.r2.ld",header=T)
tremuloides_intergene=read.table("/proj/b2010014/GenomePaper/population_genetics/GATK/HC/snp_filter/tremuloides/plink_gene_intergene_regulatory/intergene/thin_ld/3species.snp.rm_indel.biallelic.DP5.GQ10.bed.tremuloides.intergene.plink.thin.r2.ld",header=T)
#trichocarpa
trichocarpa_gene=read.table("/proj/b2010014/GenomePaper/population_genetics/GATK/HC/snp_filter/trichocarpa/plink_gene_intergene_regulatory/gene/thin_ld/3species.snp.rm_indel.biallelic.DP5.GQ10.bed.trichocarpa.gene.plink.thin.r2.ld",header=T)
trichocarpa_intergene=read.table("/proj/b2010014/GenomePaper/population_genetics/GATK/HC/snp_filter/trichocarpa/plink_gene_intergene_regulatory/intergene/thin_ld/3species.snp.rm_indel.biallelic.DP5.GQ10.bed.trichocarpa.intergene.plink.thin.r2.ld",header=T)
...
save(total_table,file="total_table.gene_regulatory_intergene.RData")
...
tremula_p
ggsave("LD.tremula.gene_regulatory_intergene.png",width=5,height=5,dpi=300)
...
tremuloides_p
ggsave("LD.tremuloides.gene_regulatory_intergene.png",width=5,height=5,dpi=300)
...
trichocarpa_p
ggsave("LD.trichocarpa.gene_regulatory_intergene.png",width=5,height=5,dpi=300)

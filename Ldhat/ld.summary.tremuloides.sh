...
#SBATCH -A b2010014
#SBATCH -p core
#SBATCH -o ld.summary.tremuloides.out
#SBATCH -e ld.summary.tremuloides.err
#SBATCH -J ld.summary.tremuloides.job
#SBATCH -t 1-00:00:00
#SBATCH --mail-user jing.wang@emg.umu.se
#SBATCH --mail-type=ALL

ld_Dir="/proj/b2010014/GenomePaper/population_genetics/GATK/HC/snp_filter/tremuloides/ld/$1"
ld_bed="/proj/b2010014/GenomePaper/population_genetics/GATK/HC/snp_filter/tremuloides/ldhat/bed/$1"
Output="/proj/b2010014/GenomePaper/population_genetics/GATK/HC/snp_filter/tremuloides/ld/summary/$1"
...
echo -e "Chr\tWin\tScaffold\tPair_Num\tr2" > $Output/ld.tremuloides.$1.summary.txt
...
echo -e "$chr\t$number\t$middle_scaffold\t$n\t$ld_mean" >> $Output/ld.tremuloides.$1.summary.txt
done

sort -k1,1V -k2,2n $Output/ld.tremuloides.$1.summary.txt > $Output/temp && mv $Output/temp $Output/ld.tremuloides.$1.summary.txt

...
#SBATCH -A b2010014
#SBATCH -p core
#SBATCH -o ld.summary.trichocarpa.out
#SBATCH -e ld.summary.trichocarpa.err
#SBATCH -J ld.summary.trichocarpa.job
#SBATCH -t 1-00:00:00
#SBATCH --mail-user jing.wang@emg.umu.se
#SBATCH --mail-type=ALL

ld_Dir="/proj/b2010014/GenomePaper/population_genetics/GATK/HC/snp_filter/trichocarpa/ld/$1"
ld_bed="/proj/b2010014/GenomePaper/population_genetics/GATK/HC/snp_filter/trichocarpa/ldhat/bed/$1"
Output="/proj/b2010014/GenomePaper/population_genetics/GATK/HC/snp_filter/trichocarpa/ld/summary/$1"
...
echo -e "Chr\tWin\tScaffold\tPair_Num\tr2" > $Output/ld.trichocarpa.$1.summary.txt
...
echo -e "$chr\t$number\t$middle_scaffold\t$n\t$ld_mean" >> $Output/ld.trichocarpa.$1.summary.txt
done

sort -k1,1V -k2,2n $Output/ld.trichocarpa.$1.summary.txt > $Output/temp && mv $Output/temp $Output/ld.trichocarpa.$1.summary.txt

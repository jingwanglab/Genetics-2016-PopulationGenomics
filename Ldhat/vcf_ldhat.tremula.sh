...
#SBATCH -A b2010014
#SBATCH -p core
#SBATCH -o Vcf_ldhat.tremula.out
#SBATCH -e Vcf_ldhat.tremula.err
#SBATCH -J Vcf_ldhat.tremula.job
#SBATCH -t 5-00:00:00
...
InputBed="/proj/b2010014/GenomePaper/population_genetics/GATK/HC/snp_filter/tremula/ldhat/bed/$2"
chr=$3
